...
function renderDashboard() {
  ...
  renderTable(
    ...
    [
      ...
      { key: "shortStrikeText", label: "Short Strike (Sell)", render: (row) => `<span class="metric-strong mono">${escapeHtml(row.shortStrikeText || "N/A")}</span>` },
      { key: "longStrikeText", label: "Long Strike (Buy)", render: (row) => `<span class="metric-strong mono">${escapeHtml(row.longStrikeText || "N/A")}</span>` },
